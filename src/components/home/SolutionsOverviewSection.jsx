        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {solutions.map((s, i) => (
                <Card
                    key={i}
                    className="p-8 bg-white border border-gray-100 rounded-2xl hover:shadow-lg hover:border-orange-200 transition-all duration-300 group"
                >
                  ...
                  <CardContent>
                    ...
                    <CustomButton variant="ghost" className="font-medium">
